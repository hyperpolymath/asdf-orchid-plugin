...
:url-repo: https://github.com/hyperpolymath/asdf-orchid-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-orchid-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-orchid-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-orchid-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Orchid] versions.
...
Orchid is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Orchid versions per project

|**Project Isolation**
|Pin Orchid per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Orchid version
...
=== Installing Orchid Versions

[source,bash]
----
asdf list all orchid
asdf install orchid latest
asdf install orchid 0.1.0
----
...
[source,bash]
----
asdf global orchid 0.1.0
asdf local orchid 0.1.0
asdf current orchid
orchid --version
----
...
* Ensure `orchid` is on PATH after installation.
* Verify the installed version with `orchid --version`.
